  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        ...
        <button onClick={() => setUploading(true)} className="flex items-center gap-2 rounded-md bg-state-success px-4 py-2 text-sm font-medium text-white hover:opacity-90"><Plus size={16} /> Upload document</button>
      </div>
        ...
        <Modal title="Upload document" onClose={() => setUploading(false)}>
          <form onSubmit={upload} className="space-y-4">
            ...
            <div className="flex justify-end gap-2 pt-2">
              ...
              <button type="submit" disabled={saving} className="flex items-center gap-2 rounded-md bg-state-success px-4 py-2 text-sm font-medium text-white hover:opacity-90 disabled:opacity-60">{saving && <Loader2 size={14} className="animate-spin" />} Upload</button>
            </div>
          </form>
        </Modal>
      )}
        ...
        <Modal title={`New version of ${reuploadTarget.name}`} onClose={() => setReuploadTarget(null)}>
          <form onSubmit={reupload} className="space-y-4">
            ...
            <div className="flex justify-end gap-2 pt-2">
              ...
              <button type="submit" disabled={saving} className="flex items-center gap-2 rounded-md bg-state-success px-4 py-2 text-sm font-medium text-white hover:opacity-90 disabled:opacity-60">{saving && <Loader2 size={14} className="animate-spin" />} Upload new version</button>
            </div>
          </form>
        </Modal>
      )}
